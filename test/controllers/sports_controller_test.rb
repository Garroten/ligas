...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { ispairs: @sport.ispairs, name: @sport.name, playernumber: @sport.playernumber }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { ispairs: @sport.ispairs, name: @sport.name, playernumber: @sport.playernumber }
    assert_redirected_to sport_path(assigns(:sport))
  end
